<template>
    <div>
        ...
        <p>El personaje debe gastar l po al día para cubrir el coste de las bebidas, de mantener las apariencias, etc. Al final del periodo de tiempo dedicado a difundir el rumor, el aventurero deberá realizar una prueba de Carisma (Engaño o Persuasión) CD 15. Si tiene éxito, la actitud predominante en la comunidad hacia el sujeto cambiará un paso hacia amistosa u hostil, lo que el personaje prefiera. Si falla, el rumor no logra acogida y cualquier intento futuro de propagarlo fracasará.</p>
        <p>Hay que tener en cuenta que modificar la percepción general en la comunidad no implica afectar la de todos sus individuos. Cada persona tendrá su propia opinión, especialmente si ya ha tratado antes con el sujeto de los rumores.</p>
    </div>
</template>
<script>
export default {
    name: 'PropagarRumores'
}
</script>